...
export const projects: Project[] = [
    ...
    new Project("Don't You (Forget About Jimny)", "🚙", "/projects/tappy-os/dont-you-forget-about-jimny", "Reminding Ryan of his Jimny love, however much the Isuzu D-Max tries to break them up.", 2026, true, true, true, [Technology.Angular, Technology.Bootstrap]),
