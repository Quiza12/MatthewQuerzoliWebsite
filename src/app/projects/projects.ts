...
export const projects: Project[] = [
    new Project("Out of Office//Pass the Parcel", "🏢", "/projects/out-of-office", "The fate of all emails in and around Christmastime.", 2026, true, true, true, [Technology.Angular, Technology.Bootstrap]),
    ...
    new Project("Tappy Standard Time", "⏰", "/projects/tappy-os/tappy-standard-time", "The timezone my illustrious, beloved girlfriend currently operates in.", 2025, true, true, false, [Technology.HTML5, Technology.Bootstrap, Technology.Javascript]),
    new Project("Tappy Season Time", "🌸", "/projects/tappy-os/tappy-season-time", "The season my beloved, illustrious girlfriend currently lives in.", 2025, true, true, false, [Technology.HTML5, Technology.Bootstrap, Technology.Javascript]),
    ...
    new Project("Don't You (Forget About Jimny)", "🚙", "/projects/tappy-os/dont-you-forget-about-jimny", "Reminding Ryan of his Jimny love, however much the Isuzu D-Max tries to break them up.", 2026, true, true, false, [Technology.Angular, Technology.Bootstrap]),
...
export const anyUnderConstruction = projects.some(p => p.underConstruction);
